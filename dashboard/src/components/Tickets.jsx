...
import { getOngoingTickets, getUsername } from "../service/ticketService";
import { Timestamp } from "firebase/firestore";
import AllCharts from "./chartPage";
...
const Tickets = () => {
    ...
    const fetchTickets = async () => {
        ...
        try {
            const ticketsData = await getOngoingTickets();
        ...
        <div>
            ...
            <div
                ...
                >
                    ...
                    <span className="text-sm text-gray-100 basis-1/4 text-left">Due in</span>
                    <span className="text-sm text-gray-100 basis-1/4 text-left">Staff</span>
            ...
            {!loading &&
                searchTickets.map((ticket) => (
                    ...
                    >
                        ...
                        <span className="text-sm basis-1/4 text-left">{getDeadline(ticket.deadline)}</span>
                        <span className="text-sm basis-1/4 text-left">{ticket.username}</span>
